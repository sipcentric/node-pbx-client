const phonenumbers = [{
  ...
  faxEnabled: false,
  links: {
    routingRules: 'https://pbx.sipcentric.com/api/v1/customers/5/phonenumbers/1/routingrules'
  },
}, {
  type: 'did',
  id: '2',
  ...
  faxEnabled: false,
  links: {
    routingRules: 'https://pbx.sipcentric.com/api/v1/customers/5/phonenumbers/2/routingrules'
  }
}, {
  type: 'did',
  id: '3',
  ...
  links: {
    routingRules: 'https://pbx.sipcentric.com/api/v1/customers/5/phonenumbers/3/routingrules'
  }
}];
