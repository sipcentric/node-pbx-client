...
class Nimvelo {
    constructor(options) {
        this.getHeaders = () => (Object.assign({}, this.options.requestOptions.headers, { Authorization: this.authorization }));
        this.init = (options) => {
        ...
        this._objectFromItem = (item, parent) => {
        ...
        this._buildObjects = (items, parent) => {
        ...
        this._request = (method, url, params = {}, callback) => {
        ...
        this._buildUrlSection = (type, object, url = '') => {
            /* eslint no-param-reassign:0 */
            let path;
        ...
        // eslint-disable-next-line class-methods-use-this
        this._paramsToQueryString = (params) => {
        ...
        this._formatGetResponse = (response, parent) => {
        ...
        this._getResource = (type, object, ...args) => {
            let id;
            let params;
            let callback;
            args.forEach((arg) => {
        ...
        this._saveRepresentation = (object, callback) => {
