...
const Queueentries = require('./queueentries');
const Queuememberships = require('./queuememberships');
  ...
  _objectFromItem(item, parent) {
    ...
    switch (item.type) {
      ...
      case 'queueentries':
        ...
        break;
      case 'queuememberships':
        object = new Queuememberships(this, item, parent);
        break;
      case 'queuestatus':
